...
What an archived file counts towards
------------------------------------
Archiving a file takes it out of the *live* half of these figures - the backlog,
the overdue counts, what a department is holding - because an archived file is
not waiting on anybody. It stays in the *historical* half: the durations, the
cycle times and the throughput are read off the approval log, and a step that
took eleven days took eleven days whether or not the file was later put away.
Archiving is a filing decision, not a way of rewriting what the Directorate did.
